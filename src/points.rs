...
mod tests {
    ...
    fn interval_one_step_away() {
        assert_eq!(point_to_interval(BV(3, 4), P(-1, 1)), I(1));
        assert_eq!(point_to_interval(BV(3, 4), P(0, -1)), I(-4));
        assert_eq!(point_to_interval(BV(3, 4), P(-1, 0)), I(-3));
        assert_eq!(point_to_interval(BV(3, 4), P(1, 0)), I(3));
        assert_eq!(point_to_interval(BV(3, 4), P(0, 1)), I(4));
        assert_eq!(point_to_interval(BV(3, 4), P(1, -1)), I(-1));
    }
    ...
    fn interval_several_step_away() {
        assert_eq!(point_to_interval(BV(3, 4), P(0, 2)), I(8));
        assert_eq!(point_to_interval(BV(3, 4), P(2, 0)), I(6));
        assert_eq!(point_to_interval(BV(3, 4), P(1, 1)), I(7));
        assert_eq!(point_to_interval(BV(3, 4), P(3, 1)), I(13));
        assert_eq!(point_to_interval(BV(3, 4), P(-3, -1)), I(-13));
